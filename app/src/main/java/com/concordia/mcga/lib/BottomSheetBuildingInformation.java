...
public class BottomSheetBuildingInformation<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BottomSheetBuildingInformation() { }
     ...
     */
    public BottomSheetBuildingInformation( Context context, AttributeSet attrs ) {
        super( context, attrs );
