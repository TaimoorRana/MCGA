...
public class Campus extends POI {
    ...
    public void populateCampusWithBuildings() {
        if (shortName.equalsIgnoreCase("SGW")) {
            ...
            Cursor res = Database.db.rawQuery("select * from building", null);
        ...
        private void populateLOYCampusWithBuildings() {
            ...
            buildings.add(new Building(new LatLng(45.458096, -73.639803), "Administration", "AD", adMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458175, -73.640261),
                            ...
                            new LatLng(45.458080, -73.640012)).setResourceImageId(R.mipmap.ic_ad_building));
            ...
            buildings.add(new Building(new LatLng(45.458335, -73.640467), "Central", "CC", ccMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458175, -73.640261),
                            ...
                            new LatLng(45.458379, -73.640806)).setResourceImageId(R.mipmap.ic_cc_building));
            ...
            buildings.add(new Building(new LatLng(45.458596, -73.641088), "Loyola Jesuit Hall And Conference Center", "RF", rfMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458518, -73.640685),
                            ...
                            new LatLng(45.458588, -73.640879)).setResourceImageId(R.mipmap.ic_rf_building));
            ...
            buildings.add(new Building(new LatLng(45.458994, -73.640456), "Psychology", "PY", pyMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459292, -73.640558),
                            ...
                            new LatLng(45.459207, -73.640631)).setResourceImageId(R.mipmap.ic_py_building));
            ...
            buildings.add(new Building(new LatLng(45.456854, -73.637734), "Recreation And Athletics Complex", "RA", raMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.456963, -73.638570),
                            ...
                            new LatLng(45.456494, -73.637359)).setResourceImageId(R.mipmap.ic_ra_building));
            ...
            buildings.add(new Building(new LatLng(45.457074, -73.637313), "Perform Center", "PC", pcMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.457118, -73.637829),
                            ...
                            new LatLng(45.456786, -73.636977)).setResourceImageId(R.mipmap.ic_pc_building));
            ...
            buildings.add(new Building(new LatLng(45.457491, -73.640380), "Communication Studies and Journalism Building", "CJ", cjMarkerOptions)
                    ...
                    ).setResourceImageId(R.mipmap.ic_cj_building));
            ...
            buildings.add(new Building(new LatLng(45.456987, -73.640445), "Center For Structural And Functional Genomics", "GE", geMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.456945, -73.640740),
                            ...
                            new LatLng(45.456919, -73.640670)).setResourceImageId(R.mipmap.ic_ge_building));
            ...
            buildings.add(new Building(new LatLng(45.457548, -73.641722), "Richard J. Renaud Science Complex", "SP", spMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.456983, -73.640829),
                            ...
                            new LatLng(45.457202, -73.640657)).setResourceImageId(R.mipmap.ic_sp_building));
            ...
            buildings.add(new Building(new LatLng(45.459658, -73.639771), "Physical Services Building", "PS", psMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459287, -73.639458),
                            ...
                            new LatLng(45.459576, -73.639230)).setResourceImageId(R.mipmap.ic_ps_building));
            ...
            buildings.add(new Building(new LatLng(45.459153, -73.639173), "Student Center", "SC", scMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458991, -73.639125),
                            ...
                            new LatLng(45.459096, -73.639042)).setResourceImageId(R.mipmap.ic_sc_building));
            ...
            buildings.add(new Building(new LatLng(45.459318, -73.638964), "Oscar Peterson Concert Hall", "PT", ptMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459163, -73.638780),
                            ...
                            new LatLng(45.459301, -73.638672)).setResourceImageId(R.mipmap.ic_pt_building));
            ...
            buildings.add(new Building(new LatLng(45.459073, -73.638395), "Vanier Library Building", "VL", vlMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458825, -73.638271),
                            ...
                            new LatLng(45.458866, -73.638237)).setResourceImageId(R.mipmap.ic_vl_building));
            // VE
            ...
            buildings.add(new Building(new LatLng(45.458848, -73.638634), "Vanier Extension", "VE", veMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458825, -73.638271),
                            ...
                            new LatLng(45.459050, -73.638865)).setResourceImageId(R.mipmap.ic_ve_building));
            ...
            buildings.add(new Building(new LatLng(45.458588, -73.639350), "F.C. Smith Building", "FC", fcMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.458380, -73.639039),
                            ...
                            new LatLng(45.458518, -73.638935)).setResourceImageId(R.mipmap.ic_fc_building));
            ...
            buildings.add(new Building(new LatLng(45.457621, -73.636172), "Stinger Dome", "DO", doMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.456958, -73.636355),
                            ...
                            new LatLng(45.457927, -73.635243)).setResourceImageId(R.mipmap.ic_do_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.459753, -73.639166), "BB", "BB", bbMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459694, -73.639168),
                            ...
                            new LatLng(45.459785, -73.639092)).setResourceImageId(R.mipmap.ic_bb_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.459727, -73.639093), "BH", "BH", bhMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459665, -73.639093),
                            ...
                            new LatLng(45.459753, -73.639018)).setResourceImageId(R.mipmap.ic_bh_building));
            ...
            buildings.add(new Building(new LatLng(45.457883, -73.642309), "St. Ignatius Of Loyaloa Church", "SI", siMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.457569, -73.642400),
                            ...
                            new LatLng(45.457626, -73.642350)).setResourceImageId(R.mipmap.ic_si_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.459370, -73.642453), "Solar House", "SH", shMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459335, -73.642363),
                            ...
                            new LatLng(45.459405, -73.642359)).setResourceImageId(R.mipmap.ic_sh_building));
            ...
            buildings.add(new Building(new LatLng(45.459300, -73.641901), "Hingston Hall, wing HB", "HB", hbMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459029, -73.641800),
                            ...
                            new LatLng(45.459396, -73.641504)).setResourceImageId(R.mipmap.ic_hb_building));
            ...
            buildings.add(new Building(new LatLng(45.459769, -73.642045), "Hingston Hall, wing HA", "HA", haMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459594, -73.642021),
                            ...
                            new LatLng(45.459768, -73.641882)).setResourceImageId(R.mipmap.ic_ha_building));
            ...
            buildings.add(new Building(new LatLng(45.459458, -73.641224), "Hingston Hall, wing HA", "HC", hcMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459253, -73.641071),
                            ...
                            new LatLng(45.459492, -73.640883)).setResourceImageId(R.mipmap.ic_hc_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.459987, -73.640898), "Terrebonne Building", "TA", taMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.459940, -73.640868),
                            ...
                            new LatLng(45.459993, -73.640827)).setResourceImageId(R.mipmap.ic_hc_building));
        ...
        private void populateSGWCampusWithBuildings() {
            ...
            buildings.add(new Building(new LatLng(45.497289, -73.578932), "Hall", "H", hMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497164, -73.579543),
                            ...
                            new LatLng(45.496834, -73.578848)).setResourceImageId(R.mipmap.ic_h_building));
            // LB
            ...
            buildings.add(new Building(new LatLng(45.496777, -73.577857), "J.W. McConnell", "LB", lbMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496686, -73.578550),
                            ...
                            new LatLng(45.496248, -73.577665)).setResourceImageId(R.mipmap.ic_lb_building));
            // GM
            ...
            buildings.add(new Building(new LatLng(45.495870, -73.578755), "Guy-De Maisonneuve Building", "GM", gmMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.495796, -73.579094),
                            ...
                            new LatLng(45.495625, -73.578736)).setResourceImageId(R.mipmap.ic_gm_building));
            // EV
            ...
            buildings.add(new Building(new LatLng(45.495466, -73.577946), "Engineering, Computer Science and Visual Arts Integrated Complex", "EV", evMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.495597, -73.578763),
                            ...
                            new LatLng(45.495205, -73.577918)).setResourceImageId(R.mipmap.ic_ev_building));
            // JM
            ...
            buildings.add(new Building(new LatLng(45.495241, -73.578925), "John Molson", "JM", jmMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.495358, -73.579366),
                            ...
                            new LatLng(45.495222, -73.579114)).setResourceImageId(R.mipmap.ic_jm_building));
            // FB
            ...
            buildings.add(new Building(new LatLng(45.494635, -73.577604), "Faubourg", "FB", fbMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.494695, -73.578040),
                            ...
                            new LatLng(45.494397, -73.577521)).setResourceImageId(R.mipmap.ic_fb_building));
            ...
            buildings.add(new Building(new LatLng(45.494170, -73.578351), "Faubourg Ste-Catherine", "FG", fgMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.493822, -73.579067),
                            ...
                            new LatLng(45.493626, -73.578728)).setResourceImageId(R.mipmap.ic_fg_building));
            // GA
            ...
            buildings.add(new SmallBuilding(new LatLng(45.494096, -73.577944), "Grey Nuns Annex", "GA", gaMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.493851, -73.578354),
                            ...
                            new LatLng(45.493790, -73.578253)).setResourceImageId(R.mipmap.ic_ga_building));
            ...
            buildings.add(new Building(new LatLng(45.493687, -73.576280), "Grey Nuns", "GN", gnMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.493908, -73.577904),
                            ...
                            new LatLng(45.493507, -73.577160)).setResourceImageId(R.mipmap.ic_gn_building));
            ...
            buildings.add(new Building(new LatLng(45.494556, -73.576056), "Montefiore", "MT", mtMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.494421, -73.576380),
                            ...
                            new LatLng(45.494298, -73.576131)).setResourceImageId(R.mipmap.ic_mt_building));
            ...
            buildings.add(new Building(new LatLng(45.494321, -73.579159), "Clinique de Médecine Industrielle et Préventive du Québec", "CL", clMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.494162, -73.579061),
                            ...
                            new LatLng(45.494261, -73.578938)).setResourceImageId(R.mipmap.ic_cl_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496611, -73.579110), "Q", "Q", qMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496553, -73.579120),
                            ...
                            new LatLng(45.496645, -73.579023)).setResourceImageId(R.mipmap.ic_q_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496653, -73.579176), "P", "P", pMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496583, -73.579180),
                            ...
                            new LatLng(45.496677, -73.579082)).setResourceImageId(R.mipmap.ic_p_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496692, -73.579267), "T", "T", tMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496629, -73.579270),
                            ...
                            new LatLng(45.496710, -73.579184)).setResourceImageId(R.mipmap.ic_t_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496710, -73.579368), "RR", "RR", rrMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496612, -73.579401),
                            ...
                            new LatLng(45.496759, -73.579255)).setResourceImageId(R.mipmap.ic_rr_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496775, -73.579412), "R", "R", rMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496711, -73.579421),
                            ...
                            new LatLng(45.496802, -73.579329)).setResourceImageId(R.mipmap.ic_r_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496803, -73.579499), "FA", "FA", faMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496736, -73.579503),
                            ...
                            new LatLng(45.496831, -73.579407)).setResourceImageId(R.mipmap.ic_fa_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496862, -73.579566), "EN", "EN", enMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496676, -73.579734),
                            ...
                            new LatLng(45.496803, -73.579607)).setResourceImageId(R.mipmap.ic_en_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496881, -73.579670), "X", "X", xMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496815, -73.579671),
                            ...
                            new LatLng(45.496907, -73.579579)).setResourceImageId(R.mipmap.ic_x_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496926, -73.579745), "Z", "Z", zMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496851, -73.579763),
                            ...
                            new LatLng(45.496949, -73.579666)).setResourceImageId(R.mipmap.ic_z_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.496956, -73.579837), "PR", "PR", prMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496895, -73.579833),
                            ...
                            new LatLng(45.496979, -73.579749)).setResourceImageId(R.mipmap.ic_pr_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497009, -73.579934), "V", "V", vMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.496927, -73.579921),
                            ...
                            new LatLng(45.497030, -73.579817)).setResourceImageId(R.mipmap.ic_v_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497356, -73.579772), "M", "M", mMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497291, -73.579781),
                            ...
                            new LatLng(45.497390, -73.579681)).setResourceImageId(R.mipmap.ic_m_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497405, -73.579844), "S", "S", sMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497327, -73.579855),
                            ...
                            new LatLng(45.497427, -73.579756)).setResourceImageId(R.mipmap.ic_s_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497472, -73.579895), "CI", "CI", ciMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497368, -73.579937),
                            ...
                            new LatLng(45.497546, -73.579759)).setResourceImageId(R.mipmap.ic_ci_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497853, -73.579579), "MU", "MU", muMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497748, -73.579628),
                            ...
                            new LatLng(45.497920, -73.579463)).setResourceImageId(R.mipmap.ic_mu_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497809, -73.579503), "B", "B", bMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497705, -73.579560),
                            ...
                            new LatLng(45.497884, -73.579385)).setResourceImageId(R.mipmap.ic_b_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497748, -73.579485), "K", "K", kMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497599, -73.579573),
                            ...
                            new LatLng(45.497686, -73.579488)).setResourceImageId(R.mipmap.ic_k_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497776, -73.579325), "D", "D", dMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497707, -73.579341),
                            ...
                            new LatLng(45.497812, -73.579235)).setResourceImageId(R.mipmap.ic_d_building));
            ...
            buildings.add(new SmallBuilding(new LatLng(45.497741, -73.579263), "MI", "MI", miMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.497623, -73.579354),
                            ...
                            new LatLng(45.497694, -73.579285)).setResourceImageId(R.mipmap.ic_mi_building));
            ...
            buildings.add(new Building(new LatLng(45.495650, -73.573885), "Visual Arts Building", "VA", vaMarkerOptions)
                    .addEdgeCoordinate(new LatLng(45.495392, -73.573749),
                            ...
                            new LatLng(45.495647, -73.573493)).setResourceImageId(R.mipmap.ic_va_building));
